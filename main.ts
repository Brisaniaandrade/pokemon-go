...
function Exit_Choosing_Pokemon_Screen () {
    ...
    ASH = sprites.create(assets.image`myImage0`, SpriteKind.Player)
...
function PAA () {
    if (NP == "Derpidash") {
        ANOTHEROP = 0
        Pokemon.setImage(assets.image`myImage4`)
        HealthBar.value += randint(-18, -38)
        ...
        Pokemon.setImage(assets.image`myImage6`)
        HealthBar.value += randint(-18, -38)
        story.printDialog("" + NP + " ATTACKED", 80, 80, 50, 150)
        ANOTHEROP = 1
        Run_Off = 0
        ...
        story.spriteMoveToLocation(Pokemon, 120, 35, 80)
        animation.stopAnimation(animation.AnimationTypes.All, Pokemon)
        Pokemon.setImage(assets.image`myImage3`)
        ...
        story.spriteMoveToLocation(Pokemon, 30, 35, 80)
        story.spriteMoveToLocation(Pokemon, 120, 35, 80)
        Pokemon.setImage(assets.image`myImage5`)
        story.printDialog("" + NP + " ATTACKED ", 80, 80, 50, 150)
        ANOTHEROP = 1
        Run_Off = 0
...
function StartBattle () {
    ...
    Pokemon = sprites.create(assets.image`myImage1`, SpriteKind.Player)
    if (NP == "Derpidash") {
        Pokemon.setImage(assets.image`myImage4`)
        Attack_Animation = 1
    } else if (NP == "Derpmander") {
        Pokemon.setImage(assets.image`myImage2`)
        Attack_Animation = 0
    } else if (NP == "Derpeon") {
        Pokemon.setImage(assets.image`myImage6`)
        Attack_Animation = 1
        ...
        Pokemon.setImage(assets.image`myImage1`)
        Attack_Animation = 1
    } else if (NP == "Derpario") {
        Pokemon.setImage(assets.image`myImage5`)
        Attack_Animation = 1
    ...
    Pokemon_Battle_Red = sprites.create(assets.image`myImage0`, SpriteKind.Player)
    ...
    if (Players__Pokemon) {
        if (true) {
            ...
            Players__Pokemon.setImage(assets.image`myImage1`)
        } else if (Change_Players_Pokemon == "Derpmander") {
            Players__Pokemon.setImage(assets.image`myImage2`)
        } else if (Change_Players_Pokemon == "Derptle") {
            Players__Pokemon.setImage(assets.image`myImage3`)
        } else if (Change_Players_Pokemon == "Derpidash") {
            Players__Pokemon.setImage(assets.image`myImage4`)
        } else if (Change_Players_Pokemon == "Derpario") {
            Players__Pokemon.setImage(assets.image`myImage5`)
        } else if (Change_Players_Pokemon == "Derpeon") {
            Players__Pokemon.setImage(assets.image`myImage6`)
        }
    }
    story.spriteMoveToLocation(Players__Pokemon, 20, 40, 100)
    Option_Box = sprites.create(assets.image`myImage7`, SpriteKind.Options_Box)
    Option_Box.setPosition(117, 95)
    RUN_OPTION = sprites.create(assets.image`myImage8`, SpriteKind.RUN)
    RUN_OPTION.setPosition(145, 102)
    FIGHT_OPTION = sprites.create(assets.image`myImage9`, SpriteKind.FIGHT)
    FIGHT_OPTION.setPosition(93, 87)
    HEAL_OPTION = sprites.create(assets.image`myImage10`, SpriteKind.SWITCH)
    HEAL_OPTION.setPosition(144, 88)
    CATCH_OPTION = sprites.create(assets.image`myImage11`, SpriteKind.CATCH)
